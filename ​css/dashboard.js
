...
(function () {
  ...
  const tooltipStyle = {
    backgroundColor: 'rgba(12,10,29,0.96)',
        ...
        datasets: [
          {
            ...
            data: t.total,
            borderColor: PURPLE,
            backgroundColor: gradient(ctx, 'rgba(168,85,247,0.35)', 'rgba(168,85,247,0.02)', 340),
            fill: true,
            tension: 0.4,
            borderWidth: 2.5,
            pointRadius: 0,
  ...
  (function renderCategories() {
    ...
    const palette = [
      ...
      '#06B6D4', '#8B5CF6', '#F472B6', '#22C55E', '#FBBF24',
      '#0EA5E9', '#D946EF', '#84CC16', '#FB923C', '#F43F5E',
    ];
  ...
  (function renderStatuses() {
    ...
    const colors = s.labels.map(l => map[l] || '#9CA3AF');
    new Chart(el.getContext('2d'), {
      type: 'doughnut',
      data: {
        labels: s.labels,
    ...
    new Chart(ctx, {
      ...
      data: {
        ...
        datasets: [{
          label: 'Requests',
          data: d.values,
          backgroundColor: gradient(ctx, 'rgba(168,85,247,0.95)', 'rgba(59,130,246,0.55)', 300),
          borderRadius: 8,
          borderSkipped: false,
          maxBarThickness: 36,
        }],
